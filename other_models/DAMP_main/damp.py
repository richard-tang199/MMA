...
from other_models.DAMP_main.utils import contains_constant_regions, nextpow2, MASS_V2
...
def DAMP_2_0(
    ...
    """
    assert (subsequence_length > 5) and (
...
if __name__ == "__main__":
    ...
    parser.add_argument("--enable_output", default=True, action="store_true")
