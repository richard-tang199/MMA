...
parser.add_argument('--model_name', type=str, default="PatchContrast", help='model name')
parser.add_argument('--group', type=str, default="7", help='group number')
parser.add_argument('--data_name', type=str, default='ASD', help='dataset name')
...
if __name__ == '__main__':
    ...
    if model_name == "PatchContrast":
        ...
        explain_scores = explainable_scores(raw_data, recon_test, explain_labels)
